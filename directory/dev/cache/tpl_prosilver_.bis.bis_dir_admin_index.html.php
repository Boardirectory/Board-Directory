...
<h2><?php echo ((isset($this->_rootref['L_BIS_ADMINISTRATION_AREA_INDEX'])) ? $this->_rootref['L_BIS_ADMINISTRATION_AREA_INDEX'] : ((isset($user->lang['BIS_ADMINISTRATION_AREA_INDEX'])) ? $user->lang['BIS_ADMINISTRATION_AREA_INDEX'] : '{ BIS_ADMINISTRATION_AREA_INDEX }')); ?></h2>
<div class="panel">
	<div class="inner">
