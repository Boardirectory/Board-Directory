...
$lang = array_merge($lang, array(
	...
	'BIS_LOG_ERROR_FATAL_BOARDCLASS'	=> '<strong>Fatal BIS Error: </strong>An error occured in the "Board" class. <br />» %s',
	'LOG_ACL_ADD_USER_GLOBAL_BIS_'		=> '<strong>Added or edited users’ BIS permissions</strong><br />» %s',
	'LOG_ACL_ADD_GROUP_GLOBAL_BIS_'		=> '<strong>Added or edited groups’ BIS permissions</strong><br />» %s',
));
